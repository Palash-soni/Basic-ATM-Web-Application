...
if (isset($_POST['Withdrawal'])) {
    ...
    if ($amt < $temp && $amt > 0) {
        ...
        $sql = "insert into $custName (Description,closing_balance) values ('Amount Withdrawn : $amt','$balance');";
    ...
    <div class="atm-container">
        ...
        <div class="atm-screen">
            <form method="post" autocomplete="off">
                ...
                <label for="withdrawal" class="label">Enter amount to Withdrawal :</label>
                <input type="number" name="amt" class="input" id="withdrawal" required>
